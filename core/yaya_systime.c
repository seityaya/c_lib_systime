...
yaya_time_fragment_t yaya_time_get(yaya_time_fragment_type_e type, yaya_time_clockid_type_e clockid) {
    ...
    case YAYA_TIME_FRAGMENT_TYPE_RESOLUTION: {
        ...
        return yaya_time_build(clock_time.tv_sec, 0, 0, clock_time.tv_nsec);
    }
    ...
    case YAYA_TIME_FRAGMENT_TYPE_USER: {
        ...
        return yaya_time_build(sec, 0, 0, nns);
    }
...
int64_t yaya_time_delay(yaya_time_fragment_t time_delay, yaya_time_clockid_type_e clockid) {
    ...
    time_beg = yaya_time_get(YAYA_TIME_FRAGMENT_TYPE_REAL, clockid);
    time_end = yaya_time_sum(time_beg, time_delay);

    do {
        time_cur = yaya_time_get(YAYA_TIME_FRAGMENT_TYPE_REAL, clockid);
        time_dif = yaya_time_dif(time_cur, time_end);
    }while(yaya_time_convflt(time_dif) < 0);
    return 0;
}
...
yaya_time_fragment_t yaya_time_dif(yaya_time_fragment_t time_fragment_1, yaya_time_fragment_t time_fragment_2) {
    yaya_time_fragment_t time_fragment = {0};
    ...
    return yaya_time_nor(time_fragment);
}

yaya_time_fragment_t yaya_time_sum(yaya_time_fragment_t time_fragment_1, yaya_time_fragment_t time_fragment_2) {
    yaya_time_fragment_t time_fragment = {0};
...
yaya_systime_float_t yaya_time_convflt(yaya_time_fragment_t time_fragment) {
    time_fragment = yaya_time_nor(time_fragment);
    // clang-format off
...
int64_t yaya_time_convstr(yaya_time_fragment_t time_fragment, char *buff, int64_t size) {
    ...
    count += scnprintf(&buff[count], size - count, "| %+22.9f fraction second |", yaya_time_convflt(time_fragment));
...
yaya_time_sys_t yaya_time_sys_get(yaya_time_clockid_type_e clockid) {
    ...
    time_sys.real = yaya_time_get(YAYA_TIME_FRAGMENT_TYPE_REAL, clockid);
    time_sys.user = yaya_time_get(YAYA_TIME_FRAGMENT_TYPE_USER, clockid);
    time_sys.sys  = yaya_time_get(YAYA_TIME_FRAGMENT_TYPE_SYS, clockid);

    return time_sys;
}

yaya_time_sys_t yaya_time_sys_nor(yaya_time_sys_t time_sys) {
    time_sys.real = yaya_time_nor(time_sys.real);
    time_sys.user = yaya_time_nor(time_sys.user);
    time_sys.sys  = yaya_time_nor(time_sys.sys);
...
yaya_time_sys_t yaya_time_sys_dif(yaya_time_sys_t time_sys_1, yaya_time_sys_t time_sys_2) {
    ...
    time_sys.real = yaya_time_dif(time_sys_1.real, time_sys_2.real);
    time_sys.user = yaya_time_dif(time_sys_1.user, time_sys_2.user);
    time_sys.sys  = yaya_time_dif(time_sys_1.sys, time_sys_2.sys);
...
yaya_time_sys_t yaya_time_sys_sum(yaya_time_sys_t time_sys_1, yaya_time_sys_t time_sys_2) {
    ...
    time_sys.real = yaya_time_sum(time_sys_1.real, time_sys_2.real);
    time_sys.user = yaya_time_sum(time_sys_1.user, time_sys_2.user);
    time_sys.sys  = yaya_time_sum(time_sys_1.sys, time_sys_2.sys);
...
int64_t yaya_time_sys_convstr(yaya_time_sys_t time_sys, char *buff, int64_t size) {
    ...
    count += yaya_time_convstr(time_sys.real, &buff[count], size - count);
    count += scnprintf(&buff[count], size - count, "\n");
    count += scnprintf(&buff[count], size - count, "user: ");
    count += yaya_time_convstr(time_sys.user, &buff[count], size - count);
    count += scnprintf(&buff[count], size - count, "\n");
    count += scnprintf(&buff[count], size - count, "sys:  ");
    count += yaya_time_convstr(time_sys.sys, &buff[count], size - count);
