...
int main(void) {
...

    {
        ...
        time_fr = yaya_time_fragment_build(-1, +900, -900, +900);
        yaya_time_fragment_convstr(time_fr, buff, BUFF_SIZE);
        ...
        time_fr = yaya_time_fragment_build(-1, +1100, -1100, +1100);
        yaya_time_fragment_convstr(time_fr, buff, BUFF_SIZE);
    ...
    printf("\n");
    {
        ...
        time = yaya_time_fragment_get(YAYA_TIME_FRAGMENT_TYPE_RESOLUTION, YAYA_TIME_CLOCK_TYPE_REALTIME);
        yaya_time_fragment_convstr(time, buff, BUFF_SIZE);
        printf("REALTIME  %s\n", buff);

        time = yaya_time_fragment_get(YAYA_TIME_FRAGMENT_TYPE_RESOLUTION, YAYA_TIME_CLOCK_TYPE_MONOTONIC);
        yaya_time_fragment_convstr(time, buff, BUFF_SIZE);
        printf("MONOTONIC %s\n", buff);
    }
    ...
    printf("\n");
    {
        ...
        time_1 = yaya_time_fragment_get(YAYA_TIME_FRAGMENT_TYPE_REAL, YAYA_TIME_CLOCK_TYPE_REALTIME);
        time_2 = yaya_time_fragment_get(YAYA_TIME_FRAGMENT_TYPE_REAL, YAYA_TIME_CLOCK_TYPE_REALTIME);

        yaya_time_fragment_convstr(time_1, buff, BUFF_SIZE);
        printf("REALTIME 1 %s\n", buff);

        yaya_time_fragment_convstr(time_2, buff, BUFF_SIZE);
        printf("REALTIME 2 %s\n", buff);

        time_3 = yaya_time_fragment_get(YAYA_TIME_FRAGMENT_TYPE_REAL, YAYA_TIME_CLOCK_TYPE_MONOTONIC);
        yaya_time_fragment_convstr(time_3, buff, BUFF_SIZE);
        printf("MONOTONIC  %s\n", buff);

        time_3 = yaya_time_fragment_dif(time_2, time_1);
        yaya_time_fragment_convstr(time_3, buff, BUFF_SIZE);
        printf("dif 21     %s\n", buff);
    }
    ...
    printf("\n");
    {
        ...
        time_1 = yaya_time_fragment_get(YAYA_TIME_FRAGMENT_TYPE_USER, YAYA_TIME_CLOCK_TYPE_REALTIME);
        time_2 = yaya_time_fragment_get(YAYA_TIME_FRAGMENT_TYPE_USER, YAYA_TIME_CLOCK_TYPE_REALTIME);
        ...
        time_3 = yaya_time_fragment_get(YAYA_TIME_FRAGMENT_TYPE_USER, YAYA_TIME_CLOCK_TYPE_MONOTONIC);
        yaya_time_fragment_convstr(time_3, buff, BUFF_SIZE);
        printf("MONOTONIC  %s\n", buff);
    ...
    printf("\n");
    {
        ...
        time_1 = yaya_time_fragment_get(YAYA_TIME_FRAGMENT_TYPE_SYS, YAYA_TIME_CLOCK_TYPE_REALTIME);
        time_2 = yaya_time_fragment_get(YAYA_TIME_FRAGMENT_TYPE_SYS, YAYA_TIME_CLOCK_TYPE_REALTIME);
        ...
        time_3 = yaya_time_fragment_get(YAYA_TIME_FRAGMENT_TYPE_SYS, YAYA_TIME_CLOCK_TYPE_MONOTONIC);
        yaya_time_fragment_convstr(time_3, buff, BUFF_SIZE);
        printf("MONOTONIC  %s\n", buff);
    ...
    printf("\n");
    {
        ...
        time_sleep = yaya_time_fragment_build(1, 111, 0, 0);
        yaya_time_fragment_convstr(time_sleep, buff, BUFF_SIZE);
        printf("sleep %s\n\n", buff);

        sys_time_1 = yaya_time_sys_get();
        yaya_time_sys_convstr(sys_time_1, buff, BUFF_SIZE);
        printf("SYSTIME 1 \n%s\n\n", buff);

        yaya_time_sleep(time_sleep, YAYA_TIME_CLOCK_TYPE_REALTIME);

        sys_time_2 = yaya_time_sys_get();
